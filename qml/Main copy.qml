    ...
    Page {
        ...
        ColumnLayout{
            ...
            RowLayout{
                ...
                height: 150
                width: parent.width
                anchors{top: spacer_header.bottom}
                Label{
            ...
            Item {
                ...
                anchors{top: panel_output.bottom}
                height: units.gu(5)
            } // Spacer
            ...
            RowLayout{
                ...
                height: 150
                width: parent.width
                anchors{top: spacer_panel_output.bottom}
                Label{
            ...
            Item {
                ...
                anchors{top: panel_preset.bottom}
                height: units.gu(5)
            } // Spacer
            ...
            Button {
                ...
                Layout.fillWidth: true
                anchors {
                    top: spacer_panel_preset.bottom
                    //left: parent.left
                    //right: parent.right
            ...
            Item {
                ...
                anchors{top: panel_eq_slider.bottom}
                height: units.gu(5)
            } // Spacer
            ...
            RowLayout {
                ...
                //height: 150
                width: parent.width
                anchors{top: spacer_panel_eq_slider.bottom}
                Button {
                    id: btn_eq_on
                    text: "EQ on"
                    //height: 150
